...
class DatabaseManager(object):
    ...
    def create_tables(self):
        ...
        # orders flag statuses:
        # IN_PROGRESS - manager has to process purchase
        # FULFILLED - client bought product
        # REJECTED - client rejected to buy
        self.query('CREATE TABLE IF NOT EXISTS clients (cid text)')
        self.query('CREATE TABLE IF NOT EXISTS orders (unique_id text, cid int, usr_name text, usr_number text, usr_address text, products text, buy_flag text)')
